...
public class StatisticsHandler extends JsonHandler<Void, Map<String, Integer>> {
	...
	@Override
	protected Map<String, Integer> handleRequest(final HttpExchange exchange, final Void request) {
